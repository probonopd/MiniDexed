...
typedef void TMidiFun (void *data, u8 ucCable, u8 ucChannel, u8 ucType, u8 ucP1, u8 ucP2);
...
void GetRoutedMIDI (TMIDIRouteMap *m_pRouteMap, u8 *pCable, u8 *pChannel, u8 *pType, u8 *pP1, u8 *pP2, bool *bSkip, TMidiFun **pFun, void **pData);
