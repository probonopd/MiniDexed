...
CMiniLab3DawConnection::CMiniLab3DawConnection (CMiniDexed *pSynthesizer, CMIDIKeyboard *pKeyboard, CConfig *pConfig, CUserInterface *pUI)
{
	...
	static TMIDIRouteMap map[] = {
		...
		{9, MIDI_NOTE_ON, 36, 0xFF, 0, MIDI_CONTROL_CHANGE, MIDI_CC_PORTAMENTO, 0x7F, .bToggle=true}, // BankA Pad1
		{9, MIDI_NOTE_OFF, 36, 0xFF, 0, MIDI_CONTROL_CHANGE, MIDI_CC_PORTAMENTO, 0x00, .bSkip=true}, // BankA Pad1
