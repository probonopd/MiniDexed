...
private:
	...
	void SetVoice (u8 ucVoice);
	void SetAlgorithm (u8 ucAlgorithm);
	void ToggleMonoMode ();
	...
	TMIDIRouteMap m_pRouteMap[46] = {
		...
		{0, 9, MIDI_NOTE_OFF, 41, 0xFF, .bSkip=true}, // BankA Pad6
		{0, 9, MIDI_NOTE_ON, 42, 0xFF, .bSkip=true}, // BankA Pad7
		{0, 9, MIDI_NOTE_OFF, 42, 0xFF, .bSkip=true}, // BankA Pad7
		{0, 9, MIDI_NOTE_ON, 43, 0xFF, .bSkip=true}, // BankA Pad8
		{0, 9, MIDI_NOTE_OFF, 43, 0xFF, 0, MIDI_CHANNEL_AFTERTOUCH, 0x00, 0xFF}, // BankA Pad8
		{0, 9, MIDI_AFTERTOUCH, 43, 0xFF, 0, MIDI_CHANNEL_AFTERTOUCH, TMIDIRouteMap::P2, 0xFF}, // BankA Pad8
		{0, 9, MIDI_NOTE_ON, 44, 0xFF, 0, MIDI_DAW_CHANGE, MIDI_DAW_TOGGLE_TG, 0}, // BankB Pad1
		{0, 9, MIDI_NOTE_OFF, 44, 0xFF, .bSkip=true}, // BankB Pad1
		{0, 9, MIDI_NOTE_ON, 45, 0xFF, 0, MIDI_DAW_CHANGE, MIDI_DAW_TOGGLE_TG, 1}, // BankB Pad2
		{0, 9, MIDI_NOTE_OFF, 45, 0xFF, .bSkip=true}, // BankB Pad2
		{0, 9, MIDI_NOTE_ON, 46, 0xFF, 0, MIDI_DAW_CHANGE, MIDI_DAW_TOGGLE_TG, 2}, // BankB Pad3
		{0, 9, MIDI_NOTE_OFF, 46, 0xFF, .bSkip=true}, // BankB Pad3
		{0, 9, MIDI_NOTE_ON, 47, 0xFF, 0, MIDI_DAW_CHANGE, MIDI_DAW_TOGGLE_TG, 3}, // BankB Pad4
		{0, 9, MIDI_NOTE_OFF, 47, 0xFF, .bSkip=true}, // BankB Pad4
		{0, 9, MIDI_NOTE_ON, 48, 0xFF, 0, MIDI_DAW_CHANGE, MIDI_DAW_TOGGLE_TG, 4}, // BankB Pad5
		{0, 9, MIDI_NOTE_OFF, 48, 0xFF, .bSkip=true}, // BankB Pad5
		{0, 9, MIDI_NOTE_ON, 49, 0xFF, 0, MIDI_DAW_CHANGE, MIDI_DAW_TOGGLE_TG, 5}, // BankB Pad6
		{0, 9, MIDI_NOTE_OFF, 49, 0xFF, .bSkip=true}, // BankB Pad6
		{0, 9, MIDI_NOTE_ON, 50, 0xFF, 0, MIDI_DAW_CHANGE, MIDI_DAW_TOGGLE_TG, 6}, // BankB Pad7
		{0, 9, MIDI_NOTE_OFF, 50, 0xFF, .bSkip=true}, // BankB Pad7
		{0, 9, MIDI_NOTE_ON, 51, 0xFF, 0, MIDI_DAW_CHANGE, MIDI_DAW_TOGGLE_TG, 7}, // BankB Pad8
		{0, 9, MIDI_NOTE_OFF, 51, 0xFF, .bSkip=true}, // BankB Pad8
		{0xFF}, // Sentinel
	};
};
...
void CMiniLab3DawConnection::MIDIListener (u8 ucCable, u8 ucChannel, u8 ucType, u8 ucP1, u8 ucP2)
{
	...
	case MIDI_CONTROL_CHANGE:
		...
		{
		case MIDI_CC_PORTAMENTO:
			SetPadColor (BankA, PortamentoPad, ucP2);
			break;
		case MIDI_CC_SOSTENUTO:
...
void CMiniLab3DawConnection::SetVoice (u8 ucVoice)
{
	std::string line2;
	for (unsigned i = 0; i < CConfig::AllToneGenerators; ++i)
	{
...
void CMiniLab3DawConnection::SetAlgorithm (u8 ucAlgorithm)
{
	char line2[LINELEN];
...
void CMiniLab3DawConnection::ToggleMonoMode ()
{
	u8 ucValue = m_pSynthesizer->GetTGParameter (CMiniDexed::TGParameterMonoMode, 0) ? 0x00 : 0x7F;
